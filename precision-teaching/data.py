...
DEFAULT_LADDERS = [
    ...
    },
    {
        ...
        "steps": [
            ...
            },
            {
                "id": "phase5_gpcs",
                "name": "Phase 5 GPCs",
                "aim": {"correctPerMin": 30, "maxErrors": 3, "timedSec": 60},
                "items": [
        ...
        "steps": [
            {
                "id": "cew_y1_a",
                "name": "CEW Y1 Set A",
                "aim": {"correctPerMin": 20, "maxErrors": 1, "timedSec": 60},
            ...
            },
            {
                ...
                "name": "CEW Y1 Set B",
                "aim": {"correctPerMin": 20, "maxErrors": 1, "timedSec": 60},
                "items": ["is", "his", "has", "I", "the", "you", "they", "were", "we", "be"],
                "untimedAim": {"accuracyPct": 100, "minTrials": 3},
            },
        ],
    },
        ...
        "steps": [
            {
                ...
                "name": "CEW Y2 Set A",
                "aim": {"correctPerMin": 20, "maxErrors": 1, "timedSec": 60},
                "items": ["door", "floor", "poor", "because", "find", "kind", "behind", "child", "children", "wild"],
                "untimedAim": {"accuracyPct": 100, "minTrials": 3},
            },
        ],
    },
    {
        "id": "common_exception_words_y3",
        "name": "Common Exception Words (Y3/4)",
        "subject": "spellings",
        "description": "Year 3/4 common exception words",
        "steps": [
            {
                "id": "cew_y34_a",
                "name": "CEW Y3/4 Set A",
                "aim": {"correctPerMin": 20, "maxErrors": 1, "timedSec": 60},
                "items": ["actual", "believe", "calendar", "different", "earth", "enough", "island", "fruit", "often", "popular"],
                "untimedAim": {"accuracyPct": 100, "minTrials": 3},
            },
        ],
    },
    {
        ...
        "subject": "spellings",
        "description": "Year 4 spelling rules and patterns",
        "steps": [
            {
                "id": "spell_y4s1",
                "name": "Y4 Homophones",
